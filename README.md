...
- read app-server config basics plus effective feature flags, user
  config-origin/layer metadata, user tools and apps config, and trusted
  project-stack scalar layers with `config/read`
...
tools/apps config, and trusted project scalar layers,
