...
checks app-server model catalog, provider-capability, config-read, and
config-requirements RPCs against temporary config homes, checks app-server
experimental feature listing and runtime enablement patching against temporary
