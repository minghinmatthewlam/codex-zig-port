...
- read app-server config basics plus effective feature flags, user
  ...
  overrides, trusted project-stack scalar, tool, and sandbox workspace layers,
  system scalar/sandbox workspace precedence, required empty user/system
  layers, and legacy managed scalar/sandbox overrides with `config/read`
...
layers plus project tool layers, system scalar/sandbox workspace precedence,
required empty user/system layers, and legacy managed scalar/sandbox overrides,
