...
- read app-server config basics plus effective feature flags, user
  ...
  and apps config, trusted project-stack scalar layers, and legacy managed
  scalar/sandbox overrides with `config/read`
...
sandbox workspace settings, tools/apps config, trusted project scalar layers,
and legacy managed scalar/sandbox overrides,
