...
- read app-server config basics plus effective feature flags, user
  ...
  and apps config, and trusted project-stack scalar layers with `config/read`
...
sandbox workspace settings, tools/apps config, and trusted project scalar layers,
