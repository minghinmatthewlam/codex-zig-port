...
| `exec` help command | covered | `codex-zig exec help`, `codex-zig exec help resume`, `codex-zig exec help review`, `codex-zig exec resume --help`, and `codex-zig exec review --help` render local help without entering the model-backed exec flow. |
