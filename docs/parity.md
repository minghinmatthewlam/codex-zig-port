...
`canceled` plus `account/login/completed` failure notification. Browser callback
completion and device-code active ChatGPT login flows remain planned.
