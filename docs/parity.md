...
special-path read-deny roots into the macOS seatbelt wrapper. Glob, unknown, and
non-root-read-only entries still return explicit unsupported-profile errors.
