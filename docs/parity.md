...
return JSON goal payloads as function-call output, and emit
`thread/goal/updated` with the active `turnId`. Automatic goal continuation,
token/time accounting, and state-DB-backed goal persistence remain planned.
