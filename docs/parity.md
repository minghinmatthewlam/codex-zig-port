...
| `exec` help command | covered | `codex-zig exec help`, `codex-zig exec help resume`, `codex-zig exec help review`, and `codex-zig exec resume --help` render local help without entering the model-backed exec flow. |
