...
restore saved goals through `thread/resume`, and emit `thread/goal/updated`
with the active `turnId`. Automatic goal continuation and full
state-DB-backed goal accounting/persistence remain planned.
