...
pub const FeatureSpec = struct {
    ...
    experimental_menu_name: ?[]const u8 = null,
    experimental_menu_description: ?[]const u8 = null,
};
...
const features = [_]FeatureSpec{
    .{ .key = "apply_patch_freeform", .stage = "removed", .default_enabled = false },
    ...
    .{ .key = "codex_git_commit", .stage = "removed", .default_enabled = false },
    ...
    .{
        ...
        .experimental_menu_name = "External migration",
        .experimental_menu_description = "Show a startup prompt when Codex detects migratable external agent config for this machine or project.",
    },
    .{ .key = "fast_mode", .stage = "stable", .default_enabled = true },
    .{ .key = "goals", .stage = "stable", .default_enabled = true },
    ...
    .{
        ...
        .stage = "experimental",
        .default_enabled = false,
        .experimental_menu_name = "Memories",
        .experimental_menu_description = "Allow Codex to create new memories from conversations and bring relevant memories into new conversations.",
    },
    .{
        .key = "mentions_v2",
        .stage = "experimental",
        .default_enabled = false,
        .experimental_menu_name = "Mentions v2",
        .experimental_menu_description = "Use a unified @ mention popup for files, folders, apps, plugins, and skills.",
    },
    ...
    .{
        ...
        .stage = "experimental",
        .default_enabled = false,
        .experimental_menu_name = "Prevent sleep while running",
        .experimental_menu_description = "Keep your computer awake while Codex is running a thread.",
    },
    ...
    .{ .key = "remote_control", .stage = "removed", .default_enabled = false },
    ...
    .{
        ...
        .experimental_menu_name = "Terminal resize reflow",
        .experimental_menu_description = "Rebuild Codex-owned transcript scrollback when the terminal width changes.",
    },
    .{ .key = "tool_call_mcp_elicitation", .stage = "stable", .default_enabled = true },
    .{ .key = "tool_search", .stage = "removed", .default_enabled = false },
    ...
    .{ .key = "unavailable_dummy_tools", .stage = "removed", .default_enabled = false },
    ...
    .{ .key = "workspace_owner_usage_nudge", .stage = "removed", .default_enabled = false },
};
